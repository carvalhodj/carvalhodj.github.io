...
function setTheme(theme) {
    ...
    // Update the floating button's appearance
    const darkModeToggle = document.getElementById('dark-mode-toggle');
    if (darkModeToggle) {
        if (theme === 'dark') {
            darkModeToggle.style.backgroundColor = '#222222'; // Dark button color
            darkModeToggle.textContent = '🌛'; // Moon icon for dark mode
        } else {
            darkModeToggle.style.backgroundColor = '#222222'; // Light button color
